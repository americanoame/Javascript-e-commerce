    ...
    >
      ...
      <Link to={`/product/${product._id}`} title={product.name}>
        ...
        <div className="absolute inset-0 transform translate-y-full group-hover:translate-y-0 duration-500 ease-in-out  items-center justify-center px-1 rounded-full opacity-0 group-hover:opacity-100 w-12 h-24 lg:flex hidden">
          <button className="text-white text-[12px] font-thin bg-pink-950 bg-opacity-90 py-2 px-1 rounded-full shadow-2xl">
            ADD TO CART
          </button>
        </div>
      </Link>
      ...
      {/* Product name */}
      <div className="mt-4 w-full text-center px-7 text-gray-900">
      ...
      {/* Product price */}
      <div className="mt-2 w-full font-thin text-center px-7 text-gray-900 sm:mt-1">
